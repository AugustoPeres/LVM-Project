...
init{
    ...
    node_1.cost_table[2].array[0] = 1;
    node_1.cost_table[2].array[1] = 1;
    node_1.cost_table[2].array[2] = 1;
    node_1.cost_table[2].array[3] = 255;

    node_2.cost_table[3].array[0] = 1;
    node_2.cost_table[3].array[1] = 1;
    node_2.cost_table[3].array[2] = 1;
    node_2.cost_table[3].array[3] = 255;

    node_3.cost_table[1].array[0] = 1;
    node_3.cost_table[1].array[1] = 1;
    node_3.cost_table[1].array[2] = 1;
    node_3.cost_table[1].array[3] = 255;
