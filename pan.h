...
#define _nstates4	14	/* never_0 */
#define minseq4	247
#define maxseq4	259
#define _endstate4	13

#define _nstates3	44	/* :init: */
#define minseq3	204
#define maxseq3	246
#define _endstate3	43

#define _nstates2	69	/* node_3_process */
#define minseq2	136
#define maxseq2	203
#define _endstate2	68

#define _nstates1	69	/* node_2_process */
#define minseq1	68
#define maxseq1	135
#define _endstate1	68

#define _nstates0	69	/* node_1_process */
#define minseq0	0
#define maxseq0	67
#define _endstate0	68
...
struct caminho { /* user defined type */
	uchar cost;
	uchar c[4];
};
struct tabela { /* user defined type */
	uchar array[4];
};
struct node { /* user defined type */
	uchar elected_node;
	uchar n;
	struct tabela cost_table[8];
	uchar cost_to_target;
	uchar current_cost;
	struct caminho caminho_atual;
	uchar costs[4];
};
...
#define Pnode_3_process	((P2 *)this)
typedef struct P2 { /* node_3_process */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pnode_2_process	((P1 *)this)
typedef struct P1 { /* node_2_process */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Pnode_1_process	((P0 *)this)
typedef struct P0 { /* node_1_process */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
